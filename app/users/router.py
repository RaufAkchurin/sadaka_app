...
from app.users.schemas import SUserInfo, UserUpdateResponseSchema, UserUpdateDataSchema
...
async def update_user(
    ...
    return await use_case.execute(user=user, update_data=update_data, picture=picture)
