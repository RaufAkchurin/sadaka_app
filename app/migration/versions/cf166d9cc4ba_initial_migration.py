...
Revision ID: cf166d9cc4ba
Revises: 
Create Date: 2025-08-21 19:34:03.950194
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.ForeignKeyConstraint(['fund_document_id'], ['funds.id'], ),
    sa.ForeignKeyConstraint(['project_document_id'], ['projects.id'], ),
    sa.ForeignKeyConstraint(['project_picture_id'], ['projects.id'], ),
    ...
    sa.ForeignKeyConstraint(['picture_id'], ['files.id'], name='fk_region_picture_id', ondelete='SET NULL', use_alter=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name'),
    sa.UniqueConstraint('picture_id')
    )
    ...
    sa.Column('language', sa.Enum('RU', 'EN', name='language_enum'), server_default='RU', nullable=False),
    sa.Column('role', sa.Enum('SUPERUSER', 'FUND_ADMIN', 'FUND_STAFF', 'USER', name='role_enum'), server_default='USER', nullable=False),
    ...
    sa.Column('status', sa.Enum('PENDING', 'CANCELED', 'WAITING_FOR_CAPTURE', 'SUCCEEDED', name='payment_status_enum'), nullable=False),
    ...
    op.create_table('user_fund_access',
