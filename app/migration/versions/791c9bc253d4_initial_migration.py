...
Revision ID: 791c9bc253d4
Revises: 
Create Date: 2025-04-18 18:29:56.962326
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("document_type", sa.Enum("DOCUMENT", "REPORT", name="doc_type_enum"), nullable=False),
