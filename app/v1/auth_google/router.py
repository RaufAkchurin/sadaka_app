...
async def google_login():
    ...
    return JSONResponse(status_code=200, content={"redirect_url": settings.google_redirect_url})
...
async def google_auth(
    ...
    if google_permitted_user:
        ...
        return RedirectResponse(url=f"{settings.APP_HOST_ADDRESS}app/v1/users/me", headers=response.headers)
    else:
