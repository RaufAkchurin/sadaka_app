...
from app.v1.project.use_cases.list import PaginationParams, Paginator, PaginatorResponseSchema, ProjectListUseCase
...
@v1_projects_router.get("/all/{status_of_project}", response_model=PaginatorResponseSchema)
async def get_projects_list(
    ...
    return await Paginator.pagination(projects, pagination.page, pagination.limit)
