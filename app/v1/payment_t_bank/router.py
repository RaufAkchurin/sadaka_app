...
# from app.v1.payment_t_bank.storage import payment_storage
#
# v1_t_bank_router = APIRouter()
#
...
#
#
# @v1_t_bank_router.post("/payments/create", response_model=PaymentResponse)
...
#
#
# @v1_t_bank_router.post("/webhook/tbank")
...
#
#
# @v1_t_bank_router.get("/payments/{payment_id}", response_model=PaymentResponse)
