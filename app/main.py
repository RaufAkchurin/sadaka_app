...
from app.v1.payment_tinkoff.router import v1_tinkoff_router
...
def register_routers(app: FastAPI) -> None:
    app.include_router(v1_tinkoff_router, prefix="/app/v1/payments/tinkoff", tags=["Payments tinkoff v1"])
